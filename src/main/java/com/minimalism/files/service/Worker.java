...
public class Worker implements Callable<InputBufferReadStatus> {
    ...
    public Worker(long thisBatchOffsetInFile, int iteration,  IFileReader fileReader, RecordDescriptor recordDescriptor) {
    ...
    public InputBufferReadStatus call() throws Exception {
        ...
        return this.fileReader.read(this.thisBatchOffsetInFile, this.iteration, this.recordDescriptor);
    }
